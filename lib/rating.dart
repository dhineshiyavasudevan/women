...
void main() => runApp(Dp10());

class Dp10 extends StatefulWidget {
  @override
  _MyAppState createState() => _MyAppState(Dp10);
}

class _MyAppState extends State<Dp10> {
  ...
  _MyAppState(this.ratingController);
